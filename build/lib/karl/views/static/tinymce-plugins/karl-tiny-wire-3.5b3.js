...
$(document).ready(function() {
    ...
    ///var plugins = 'paste,embedmedia,spellchecker,imagedrawer,advimagescale,advlist,print,table,autosave0';
    ...
    // KARL static
    var static_url = head_data.karl_static_url;
    // the root url of the tinymce tree
    var tinymce_url = head_data.karl_static_url; // XXX XXX XXX
    ...
    // the root url of the tinymce tree
    //var tinymce_url = $('#jslibs-static-url')[0].content + '/externals/tinymce/3.5b3/jscripts/tiny_mce';
    ...
    ////$.each(['advimagescale', 'embedmedia', 'imagedrawer', 'kaltura', 'wicked', 'autosave0'], function(index, plugin_name) {
    $.each(['advimagescale', 'embedmedia', 'imagedrawer', 'kaltura', 'wicked'], function(index, plugin_name) {
        tinymce.PluginManager.load(plugin_name, static_url + '/tinymce-plugins/' + plugin_name + '/');
    });
    tinymce.ThemeManager.load('advanced', static_url + '/tinymce-plugins/' + 'theme-advanced-3.5b3' + '/editor_template.js');
    ...
    $('.mceEditor').tinysafe({
        ...
        // autosave needs a discriminator
        ////autosave0_discriminator: window.location.href
    });
