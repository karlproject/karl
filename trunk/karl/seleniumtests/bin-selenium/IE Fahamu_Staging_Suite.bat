...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://staging.fahamu.sixfeetup.com/" "../staging_suite.html" "../log/results_ie_staging_fahamu_suite.html"
