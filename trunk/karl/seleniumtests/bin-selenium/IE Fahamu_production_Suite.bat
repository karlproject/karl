...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "https://intranet.fahamu.org/" "../production_suite.html" "../log/results_ie_Fahamu_production_Suite.html"
