...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://staging.ospc.sixfeetup.com/" "../staging_suite1.html" "../log/results_ie_staging_ospc_suite.html"
