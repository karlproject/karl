...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "https://efnetwork.org/" "../production_suite.html" "../log/results_fx_Eurasia_production_suite.html"
