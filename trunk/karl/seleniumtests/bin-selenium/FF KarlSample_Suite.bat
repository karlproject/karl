...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://kdi-dev.sixfeetup.com:6543/" "../all_suite1.html" "../log/results_fx_kdi-dev_KarlSample_Suite.html"
