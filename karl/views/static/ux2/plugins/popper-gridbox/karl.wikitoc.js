        ...
        _create: function () {
            ...
            this.element.append(
              '<div class="karl-wikitoc-gridwrapper ui-helper-clearfix">' +
                ...
                '<div class="karl-wikitoc-inspector">' +
                  '<div class="karl-wikitoc-inspector-wrapper">' +
                    '<div class="karl-wikitoc-inspector-wrapper2">' +
                      ...
                      '<fieldset class="karl-wikitoc-columnselectors">' +
                          ...
                          '<div>' +
                              ...
                              '<div>' +
                                '<input class="karl-wikitoc-cb-title" type="checkbox" checked="checked">' +
                                '</input>' +
                                '<label>Title</label>' +
                              '</div>' +
                              '<div>' +
                                '<input class="karl-wikitoc-cb-author_name" type="checkbox" ' +
                                'checked="checked">' +
                                '</input>' +
                                '<label>Author</label>' +
                              '</div>' +
                              ...
                              '</div>' +
                              '<div>' +
                                '<input class="karl-wikitoc-cb-created" type="checkbox" ' +
              ...
              '<div class="' + footer_classes + '">' +
                '<span class="karl-wikitoc-items">' +
                '<span class="karl-wikitoc-items-num">0</span> items</span>' +
                button +
              '</div>'
            );
            ...
            this.grid_columns = [
                {id: "title", name: "Title", field: "title", formatter: TitleCellFormatter,
                    width: 320, minWidth: 20, sortable: true},
                {id: "author_name", name: "Author", field: "author_name", formatter: AuthorCellFormatter,
                    width: 80, minWidth: 20, sortable: true},
                {id: "tags", name: "Tags", field: "tags",
                    width: 140, minWidth: 20, sortable: false},
                {id: "created", name: "Created", field: "created", formatter: DateCellFormatter,
                    width: 60, minWidth: 20, sortable: true},
                {id: "modified", name: "Modified", field: "modified", formatter: DateCellFormatter,
                    width: 60, minWidth: 20, sortable: true}
            ];
            ...
            // Modification for UX2: pin the header padding.
            //
