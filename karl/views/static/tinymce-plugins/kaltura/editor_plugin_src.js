            ...
            ed.addCommand('mceKaltura', function () {
                ...
                var callback = function (success, session_key) {
                    if (success) {
                        ...
                        window._onContributionWizardAddEntry = function (entries) {
                            self._onContributionWizardAddEntry(entries);
                        };
                        window._onContributionWizardClose = function () {
                            self._onContributionWizardClose();
                        };
