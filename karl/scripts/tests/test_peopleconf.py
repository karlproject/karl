...
"""Tests of karl.scripts.peopleconf"""
...
class ParseErrorTests(unittest.TestCase):
    ...
    def _getTargetClass(self):
        from karl.scripts.peopleconf import ParseError
        return ParseError
...
class IdAndTitleTests(unittest.TestCase):
    ...
    def _callFUT(self, elem):
        from karl.scripts.peopleconf import id_and_title
...
class SetAclTests(unittest.TestCase):
    ...
    def _callFUT(self, obj, elem):
        from karl.scripts.peopleconf import set_acl
...
class ParseReportTests(unittest.TestCase):
    ...
    def _callFUT(self, peopledir, elem):
        from karl.scripts.peopleconf import parse_report
...
class ParseReportsTests(unittest.TestCase):
    ...
    def _callFUT(self, peopledir, parent_elem, reportmap):
        from karl.scripts.peopleconf import parse_reports
...
class ParseSectionTests(unittest.TestCase):
    ...
    def _callFUT(self, peopledir, elem):
        from karl.scripts.peopleconf import parse_section
...
class PeopleConfTests(unittest.TestCase):
    ...
    def _callFUT(self, peopledir, elem):
        from karl.scripts.peopleconf import peopleconf
...
class ReindexTests(unittest.TestCase):
    ...
    def _callFUT(self, peopledir):
        from karl.scripts.peopleconf import reindex
        reindex(peopledir)
