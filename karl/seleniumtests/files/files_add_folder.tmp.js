module.exports = function testFilesAddFolder (browser, lbParam, verificationErrors)  {

    if (!lbParam) lbParam = {vuSn: 1};
    var assert = require('assert');
    var baseUrl = "http://change-this-to-the-site-you-are-testing/";
    var acceptNextAlert = true;
    browser.get(addUrl(baseUrl, "/communities/selenium_test/files/?status_message=Deleted+test+folder"));
    browser.elementByLinkText("FILES").click();
    browser.elementByLinkText("Add Folder").click();
