...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://karlhost01.sixfeetup.com:8100/" "../all_Suite.html" "../log/results_fx_karlhost01_Eurasia_Suite.html"
