...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://staging.eurasia.sixfeetup.com/" "../all_Suite.html" "../log/results_fx_staging_eurasia_Suite.html"
