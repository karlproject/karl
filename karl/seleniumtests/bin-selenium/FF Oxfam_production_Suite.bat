...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "https://karl.oxfam.org.uk/" "../all_suite1.html" "../log/results_fx_OXFAM_production_suite.html"
