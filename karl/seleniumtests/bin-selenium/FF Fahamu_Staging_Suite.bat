...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://staging.fahamu.sixfeetup.com/" "../staging_suite.html" "../log/results_fx_staging_fahamu_Suite.html"
