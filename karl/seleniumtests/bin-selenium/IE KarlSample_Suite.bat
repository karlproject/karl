...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://kdi-dev.sixfeetup.com:6543/" "../all_suite.html" "../log/results_ie_kdi-dev_KarlSample_Suite.html"
