...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://karlhost01.sixfeetup.com:8100/" "../Eurasia_Suite.html" "../log/results_ie_karlhost01_Eurasia_Suite.html"
