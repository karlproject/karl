...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://staging.eurasia.sixfeetup.com/" "../all_suite.html" "../log/results_ie_staging_eurasia_suite.html"
