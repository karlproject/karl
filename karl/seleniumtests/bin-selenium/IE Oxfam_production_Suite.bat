...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://karl.oxfam.org.uk/" "../all_suite1.html" "../log/results_ie_OXFAM_production_suite.html"
