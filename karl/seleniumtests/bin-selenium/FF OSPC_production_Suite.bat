...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "https://karl.opensocietypolicycenter.org/" "../all_suite1.html" "../log/results_fx_OSPC_production_suite.html"
