...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://kdi-dev.sixfeetup.com:8300/" "../all_suite.html" "../log/results_fx_kdi-dev_OSPC_Suite.html"
