...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://kdi-dev.sixfeetup.com:8100/" "../Fahamu_Suite.html" "../log/results_ie_kdi-dev_Fahamu_Suite.html"
