...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "https://karl.opensocietypolicycenter.org/" "../all_suite1.html" "../log/results_ie_OSPC_production_suite.html"
