...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "https://intranet.fahamu.org/" "../all_suite.html" "../log/results_fx_Fahamu_production_Suite.html"
