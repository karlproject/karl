...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://staging.osi.sixfeetup.com/" "../OSI_suite.html" "../log/results_fx_staging_osi_suite.html"
