...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://kdi-dev.sixfeetup.com:8300/" "../all_suite1.html" "../log/results_ie_kdi-dev_OSPC_Suite.html"
