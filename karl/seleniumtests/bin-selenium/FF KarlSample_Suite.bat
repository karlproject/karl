...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://kdi-dev.sixfeetup.com:6543/" "../KarlSample_Suite.html" "../log/results_fx_kdi-dev_KarlSample_Suite.html"
