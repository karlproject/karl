...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://staging.gcfe.sixfeetup.com/" "../all_suite1.html" "../log/results_ie_GCFE_staging_Suite.html"
