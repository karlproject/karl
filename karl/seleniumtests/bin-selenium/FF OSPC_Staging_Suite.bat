...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*firefox" "http://karlhost01.sixfeetup.com:8400/" "../all_suite1.html" "../log/results_fx_Karlhost01_OSPC_Suite.html"
