...
java -jar "selenium-server-1.0.1\selenium-server.jar" -htmlSuite "*iexplore" "http://karlhost01.sixfeetup.com:8200/" "../Fahamu_Suite.html" "../log/results_ie_Karlhost01_Fahamu_Suite.html"
