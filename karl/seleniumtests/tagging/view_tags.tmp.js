module.exports = function testViewTags (browser, lbParam, verificationErrors)  {
    ...
    browser.elementByXPath("//div[@id='cheader']/span/a[2]").click();
    /* Warning: assertTextPresent may require manual changes */
    assert.strictEqual(browser.elementByCssSelector("BODY").text().match("^[\\s\\S]*Tag Cloud[\\s\\S]*$"), true, 'Assertion error: Expected: true, Actual:' browser.elementByCssSelector("BODY").text().match("^[\\s\\S]*Tag Cloud[\\s\\S]*$"));
