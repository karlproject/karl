module.exports = function testAddTags (browser, lbParam, verificationErrors)  {
    ...
    browser.elementByXPath("//form[@id='tag-inputbox']/div/ul/li/span/input").clear();
    browser.elementByXPath("//form[@id='tag-inputbox']/div/ul/li/span/input").sendKeys("selenium_test");
    browser.elementByXPath("//button[@type='button']").click();
