module.exports = function testForumsAdd (browser, lbParam, verificationErrors)  {
    ...
    browser.elementByLinkText("Add Forum").click();
    /* ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.] */
    /* ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.] */
    /* ERROR: Caught exception [Error: locator strategy either id or name must be specified explicitly.] */
    assert.equal("selenium_test", browser.title(), 'Assertion error: Expected: "selenium_test", Actual: ' + browser.title());
