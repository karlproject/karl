module.exports = function testCalendarSearch (browser, lbParam, verificationErrors)  {
    ...
    browser.elementByXPath("//form[@id='kcommunitysearch']/fieldset/input[1]").sendKeys("calendar_test_event_123");
